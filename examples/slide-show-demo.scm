  ...
  (let* ([pdf (hpdf-new)]
    ...
    (map-with-index
     ...
     `((,HPDF_TS_WIPE_RIGHT "HPDF_TS_WIPE_RIGHT")
       (,HPDF_TS_WIPE_UP "HPDF_TS_WIPE_RIGHT")
       (,HPDF_TS_WIPE_LEFT "HPDF_TS_WIPE_RIGHT")
       (,HPDF_TS_WIPE_DOWN "HPDF_TS_WIPE_RIGHT")
       (,HPDF_TS_BARN_DOORS_HORIZONTAL_OUT "HPDF_TS_WIPE_RIGHT")
       (,HPDF_TS_BARN_DOORS_HORIZONTAL_IN "HPDF_TS_WIPE_RIGHT")
       (,HPDF_TS_BARN_DOORS_VERTICAL_OUT "HPDF_TS_WIPE_RIGHT")
       (,HPDF_TS_BARN_DOORS_VERTICAL_IN "HPDF_TS_WIPE_RIGHT")
       (,HPDF_TS_BOX_OUT "HPDF_TS_WIPE_RIGHT")
       (,HPDF_TS_BOX_IN "HPDF_TS_WIPE_RIGHT")
       (,HPDF_TS_BLINDS_HORIZONTAL "HPDF_TS_WIPE_RIGHT")
       (,HPDF_TS_BLINDS_VERTICAL "HPDF_TS_WIPE_RIGHT")
       (,HPDF_TS_DISSOLVE "HPDF_TS_WIPE_RIGHT")
       (,HPDF_TS_GLITTER_DOWN "HPDF_TS_WIPE_RIGHT")
       (,HPDF_TS_GLITTER_RIGHT "HPDF_TS_WIPE_RIGHT")
       (,HPDF_TS_GLITTER_TOP_LEFT_TO_BOTTOM_RIGHT "HPDF_TS_WIPE_RIGHT")
       (,HPDF_TS_REPLACE "HPDF_TS_WIPE_RIGHT")))
