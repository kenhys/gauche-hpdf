...
(define (main args)
  (let* ([pdf (hpdf-new)]
    ...
    (draw-line page 60 680 "dash_ptn=[3], phase=1 -- 2 on, 3 off, 3 on...")

    (dash! page DASH_MODE2 2)
    (draw-line page 60 650 "dash_ptn=[7, 3], phase=2 -- 5 on 3 off, 7 on,...")

    (dash! page DASH_MODE3 0)
    (draw-line page 60 620 "dash_ptn=[8, 7, 2, 7], phase=0")
    ...
    (draw-line2 page 60 440 "PDF_PROJECTING_SCUARE_END")
