...
(let* ((doc (hpdf-new)))
  (hpdf-save-to-file doc "data/page_0.pdf"))

(let* ((doc (hpdf-new))
       (page_1 (hpdf-add-page doc)))
  (hpdf-save-to-file doc "data/page_1.pdf"))

(let* ((doc (hpdf-new))
       (page_1 (hpdf-add-page doc))
       (page_1 (hpdf-add-page doc)))
  (hpdf-save-to-file doc "data/page_2.pdf"))

(let* ((doc (hpdf-new))
       (page_1 (hpdf-add-page doc))
       (dummy (hpdf-save-to-file doc "data/page1_1.pdf"))
       (page_1 (hpdf-add-page doc))
       (dummy (hpdf-save-to-file doc "data/page1_2.pdf"))
       )
  (hpdf-save-to-file doc "data/page1.pdf"))
...
(let* ((doc (hpdf-new))
       ...
       (font-name (hpdf-load-ttf-font-from-file doc "font/ipag.ttf" #f))
       ...
       (s (hpdf-page-begin-text page_1))
       (null (print s))
       (dummy (hpdf-page-show-text page_1 "Hello, World0Oあいう"))
       (dummy (hpdf-page-end-text page_1))
       )
  (hpdf-save-to-file doc "data/hpdf_showtext2.pdf"))
