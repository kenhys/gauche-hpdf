...
(test-section "hpdf-load-png-image-from-file")
...
(test-subsubsection "Basic formats")
(mktest basic-formats)

(test-subsubsection "Interlacing")
(mktest	interlacing)

(test-subsubsection "Odd sized")
(mktest	odd-sizes)

(test-subsubsection "Background colors")
(mktest	background-colors)

(test-subsubsection "Gamma values")
(mktest	gamma-values)

(test-subsubsection "Image filtering")
(mktest	image-filtering)

(test-subsubsection "Additional palettes")
(mktest	additional-palettes)

(test-subsubsection "Ancillary chunks")
(mktest	ancillary-chunks)

(test-subsubsection "Chunk ordering")
(mktest	chunk-ordering)

(test-subsubsection "Zlib compression")
(mktest	zlib-compression)

(define (mktest arg)
  (map-with-index
   (^ (index arg) (mktest-proc *test-error* (car arg) (cadr arg))) arg))
