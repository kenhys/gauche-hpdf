...
(test* "September L proportional embed" "unsupported" (test-hpdf-load-ttf-font-from-file "font/september-l-p.ttf" #t))
...
(test* "Anito M proportional embed" "unsupported" (test-hpdf-load-ttf-font-from-file "font/anito-m-p.ttf" #t))
(test* "Anito M monospace embed" "unsupported" (test-hpdf-load-ttf-font-from-file "font/anito-m-mono.ttf" #t))
(test* "Anito Relief embed" "unsupported" (test-hpdf-load-ttf-font-from-file "font/anito-relief.ttf" #t))
(test* "Arare monospace embed" "Aralet-Mono-Kyohkan,Mono-Kyohkan" (test-hpdf-load-ttf-font-from-file "font/arare-mono.ttf" #t))
(test* "Arare proportional embed" "unsupported" (test-hpdf-load-ttf-font-from-file "font/arare-p.ttf" #t))
(test* "elegant w3 embed" "ElgseionW3.TTF" (test-hpdf-load-ttf-font-from-file "font/elegant-w3.ttf" #t))
(test* "elegant w5 embed" "ElgseionW5.TTF" (test-hpdf-load-ttf-font-from-file "font/elegant-w5.ttf" #t))
(test* "elegant w7 embed" "ElgseionW7.TTF" (test-hpdf-load-ttf-font-from-file "font/elegant-w7.ttf" #t))
(test* "elegant w9 embed" "ElgseionW9.TTF" (test-hpdf-load-ttf-font-from-file "font/elegant-w9.ttf" #t))
